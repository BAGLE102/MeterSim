...
#	for i in xrange(4):
	...
	net.addLink(OFSwitchList[0], OFSwitchList[2])
	net.addLink(OFSwitchList[0], OFSwitchList[3])
	
	net.addLink(OFSwitchList[1], OFSwitchList[4])
	net.addLink(OFSwitchList[2], OFSwitchList[4])
	net.addLink(OFSwitchList[3], OFSwitchList[4])
	
	net.addLink(HostList[1], OFSwitchList[4])
